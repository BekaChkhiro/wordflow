...
export default function TypingContainer({ phrases, level, category }: TypingContainerProps) {
    ...
    try {
      const res = await fetch('/api/progress/update', {
        ...
        body: JSON.stringify({
          ...
          correct: isCorrect,
          mistakeType: isCorrect ? undefined : 'typing',
          userAnswer,
        }),
      })
  ...
  return (
    <div className="space-y-6">
      ...
      <TypingQuestion
        ...
        correctAnswer={currentPhrase.english}
