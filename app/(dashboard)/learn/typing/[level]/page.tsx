...
import TypingContainer from '@/components/learn/typing/TypingContainer'
...
export default async function TypingPage({ params, searchParams }: PageProps) {
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Typing Practice</h1>
