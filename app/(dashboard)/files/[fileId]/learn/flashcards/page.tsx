...
import FileFlashcardDeck from '@/components/files/FileFlashcardDeck'

interface FlashcardsPageProps {
  params: Promise<{ fileId: string }>
}

export default async function FileFlashcardsPage({ params }: FlashcardsPageProps) {
    ...
    <div className="-m-6 min-h-[calc(100%+3rem)] bg-white p-6">
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">ბარათები</h1>
