...
import FileTypingContainer from '@/components/files/FileTypingContainer'

interface TypingPageProps {
  params: Promise<{ fileId: string }>
}

export default async function FileTypingPage({ params }: TypingPageProps) {
    ...
    <div className="-m-6 min-h-[calc(100%+3rem)] bg-white p-6">
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">აკრეფა</h1>
      ...
      <div className="max-w-xl mx-auto">
        <FileTypingContainer words={file.words} fileId={fileId} />
      </div>
    </div>
  )
}
